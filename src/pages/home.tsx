...
const Home = () => {
  return (
    <div class="flex flex-col items-center justify-center min-h-[calc(100vh-12rem)]">
      <h1 class="text-4xl sm:text-5xl font-bold mb-3 text-amber-900">utilsofmike</h1>
      ...
      <div class="bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-xl p-5 mb-10 max-w-2xl w-full text-center">
        <p class="text-amber-900 text-sm sm:text-base">
          Welcome to an open-source web app! 🚀 Feel free to contribute, build free tools for our community, and level up your <strong>TypeScript</strong> & <strong>SolidJS</strong> skills.
        </p>
      </div>
